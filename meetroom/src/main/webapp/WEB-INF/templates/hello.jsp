...
<div class="index-nav">
    <div class="container">
        <div class="index-logo">
            <a href="#" class=""><img src="img/logo-index.png"></a>
        </div>
...
<div class="container wrap">
    <ul>
        <li class="company-details clearfix">
            <div class="fl"><img src="img/Bitmap1.jpg" height="300" width="490"></div>
        ...
        <li class="company-details clearfix">
            <div class="fr"><img src="img/Bitmap2.jpg" height="300" width="490"></div>
