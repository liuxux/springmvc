...
public class LoginController {
   // private Logger logger = Logger.getLogger(this.getClass());
    ...
    //接受前端信息
    public List<User> listAll(HttpServletRequest request) throws Exception {
//    public String listAll(HttpServletRequest request) throws Exception {
        //参数解析  将获取到的参数 记录下来
        // 定义类型 并标明接收的数据类型
...
//        mav.addObject("login", userList);
        return userList;
//        return "/WEB-INF/templates/register/bookMeetingroom.vm";
    }
